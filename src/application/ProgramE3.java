...
public class ProgramE3 {
	...
	public static void main(String[] args) {
		 ...
		 * TIPO DE CONTA, QUE É COMO SE FOSSE VOCE SEPARAR UMA CERTA QUANTIDADE DE ESPAÇO DE MEMORIA PARA COLOCAR
		 * CERTO TIPO DE COISA, NO CASO DESTE EXERCICIO, FOI SEPARAR 20 ESPAÇOS DE MEMORIA PARA COLOCAR VINTE
		 * CONTAS, ALEM DISSO, TERIAMOS QUE FAZER OPERAÇOES PARA PEGAR O PRIMEIRO ELEMENTO INSERIDO NESTE ESPAÇO,
		 * O ULTIMO E QUANTOS ELEMENTOS TEM INSERIDO NO TOTAL, APRENDI QUE NESSA FORMA, O TAMANHO É FIXO, 
		 * OU SEJA, EU SÓ POSSO COLOCAR APENAS 20 CONTAS, CASO SURJA A 21 CONTA NÃO PODERIA COLOCAR, ESSE 
		 * METODO TAMBEM É MAIS LENTO, SE EU QUISER VER A ULTIMA CONTA, TENHO QUE IR UM POR UM, ATÉ A ULTIMA
		 * CONTA*/
